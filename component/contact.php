...
<div
  id="contact"
  class="text-center bg-[url('src/assets/contact.jpg')] bg-center bg-cover bg-no-repeat text-white py-8 px-3 scroll-mt-25">
  ...
  <p class="text-lg/[22px] pt-1">
    Have a project idea or partnership proposal? Let’s connect and bring it to
    life.
  </p>
</div>
<!-- End Contact Us -->
